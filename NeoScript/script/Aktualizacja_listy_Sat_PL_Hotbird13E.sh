...
if [ -f /tmp/$e2lista ] ; then
    [ $PL ] && echo "Listy kanaĹ‚Ăłw pobrana prawidĹ‚owo" || echo "Channel lists downloaded";
   ...
   if [ ! -f /usr/bin/curl ] ; then
        ...
        echo "Sprobuj aktualizacji jeszcze raz..."        
    else
