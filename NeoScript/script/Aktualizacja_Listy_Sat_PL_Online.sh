...
LinkNeoList='https://raw.githubusercontent.com/gutosie/neoscript/main/NeoScript/neodir/e2iptvhb'
cd /tmp
...
if [ -f /usr/bin/wget ] ; then
    ...
    wget -q --no-check-certificate https://raw.githubusercontent.com/gutosie/neoscript/main/NeoScript/neodir/e2iptvhb > /dev/null 2>&1
    if [ ! -f /tmp/e2iptvhb ] ; then
...
if [ -f /tmp/e2iptvhb ] ; then
    ...
    echo "________________________________" ;
    sleep 2
    /bin/tar -xzvf /tmp/e2iptvhb -C / > /dev/null 2>&1;
